        ...
        <div className="grid grid-cols-1 gap-8 mt-8 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="relative z-20 max-w-lg p-6 mx-auto -mt-20 bg-white rounded-md shadow dark:bg-gray-900">
              ...
              <p className="mt-3 text-sm text-blue-500">Date: 2018</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative z-20 max-w-lg p-6 mx-auto -mt-20 bg-white rounded-md shadow dark:bg-gray-900">
              ...
              <p className="mt-3 text-sm text-blue-500">Date: 2020</p>
            </div>
          </div>
        </div>
        {/* Card 3: BSc in CSE */}
        <div className="mt-6">
          ...
          <div className="relative z-20 max-w-lg p-6 mx-auto -mt-20 bg-white rounded-md shadow dark:bg-gray-900">
            <a
              ...
              className="font-semibold text-gray-800 hover:underline dark:text-white md:text-xl"
            >
              Current Pursuit: BSc in Computer Science and Engineering
            </a>
            <p className="mt-3 text-sm text-gray-500 dark:text-gray-300 md:text-sm">
              Currently pursuing BSc in Computer Science and Engineering at
              Begum Rokeya University.
            </p>
            <p className="mt-3 text-sm text-blue-500">Ongoing</p>
          </div>
        </div>
      </div>
    </section>
